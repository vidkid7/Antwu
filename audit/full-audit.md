...
- Added styled 404 and 500 experiences: the root not-found page, a recoverable route-level `error.tsx`, a standalone `/500` route, and a global error fallback. The 404 and `/500` smoke checks render at 1440px with 0 axe violations and no console/page errors.
