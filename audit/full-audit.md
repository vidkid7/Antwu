...
- Added a custom eased anchor-scroll controller with a 640–1100 ms duration for a smoother, slightly slower transition. Reduced-motion users bypass the animation and retain instant scrolling.
