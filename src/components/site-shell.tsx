...
import { ArrowRight, ChevronDown, Facebook, Instagram, Linkedin, Mail, MapPin, Menu, Phone, X } from '@/components/icons';
...
export function PublicHeader() {
  ...
  return <><a href="#main-content" className="skip-link"><L value={{ en: 'Skip to content', ne: 'मुख्य सामग्रीमा जानुहोस्' }} /></a><div className="utility-strip"><div className="container utility-inner"><div className="utility-social" aria-label={lang === 'ne' ? 'सामाजिक सञ्जाल' : 'Social media'}><a href={row?.facebook || 'https://www.facebook.com/'} target="_blank" rel="noreferrer" aria-label="Facebook"><Facebook size={21} strokeWidth={2.4} /></a><a href={row?.instagram || 'https://www.instagram.com/'} target="_blank" rel="noreferrer" aria-label="Instagram"><Instagram size={22} strokeWidth={2.2} /></a><a href="https://www.linkedin.com/" target="_blank" rel="noreferrer" aria-label="LinkedIn"><Linkedin size={21} strokeWidth={2.4} /></a></div><div className="utility-actions"><a className="utility-location" href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(row?.address?.en || 'Peris Dada, Kathmandu')}`} target="_blank" rel="noreferrer"><MapPin size={19} strokeWidth={2.4} /><span><L value={{ en: 'Peris Dada, Kathmandu', ne: 'पेरिस डाडा, काठमाडौं' }} /></span></a><LanguageSwitcher /></div></div></div>
